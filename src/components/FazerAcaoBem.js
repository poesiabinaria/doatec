...
function FazerAcaoBem() {
    ...
    return ( <
        ...
        Form.Group as = { Row }
        onChange = {
            (e) => setRadioTipoEquip(e.target.value)
        } >
        <
        Col >
        <
        Form.Check name = "radioEquipamento"
        type = "radio"
        id = "checkComputador"
        label = "Computador"
        value = "computador" /
        ...
        Form.Group as = { Row }
        onChange = {
            (e) => setRadioEscala(e.target.value)
        } >
        <
        Col >
        <
        Form.Check name = "escala"
        type = "radio"
        label = "1"
        value = "1"
        inline /
        ...
        rows = { 3 }
        onChange = {
            (e) => setInputProblEquip(e.target.value)
        }
        /> < /
        Form.Group >
        ...
        rows = { 3 }
        onChange = {
            (e) => setInputReparoEquip(e.target.value)
        }
        /> < /
        Form.Group >
        ...
        <
        Form.File onChange = {
            (e) => setInputImgEquip(e.target.value)
        }
        /> < /
        Form.Group >
        ...
        rows = { 3 }
        onChange = {
            (e) => setInputDescrEqui(e.target.value)
        }
        /> < /
        Form.Group >
